...
paymentRoute.get('/vnpay_return', function (req, res, next) {

    console.log("vo trong return roi neeeeeeeeeeee");
    ...
    if(secureHash === signed){
        ...
        res.send('success', {code: "thanhcongroi"})
    } else{
        res.send('success', {code: '97'})
    }
});

paymentRoute.get('/vnpay_ipn', function (req, res, next) {
    let vnp_Params = req.query;
    let secureHash = vnp_Params['vnp_SecureHash'];
...
paymentRoute.post('/querydr', function (req, res, next) {
